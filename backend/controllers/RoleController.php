 ...
 *
 * @property \maddoger\user\backend\Module $module
 */
class RoleController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        ...
                        'allow' => true,
                        'roles' => ['user.rbac.updateFromModules'],
                    ],
                    [
                        'actions' => ['delete'],
                        'allow' => true,
    ...
    public static function updateRoles($removeAll = false)
    {
        ...
        if (!$superUserRole) {
            ...
            $superUserRole->description = Yii::t('maddoger/user', 'Superuser');
            if (!$authManager->add($superUserRole)) {
                $log[] = [
                    'error',
                    Yii::t('maddoger/user', '"{itemName}" ... error ({error})', [
                ...
                $log[] = [
                    'ok',
                    Yii::t('maddoger/user', '"{itemName}" ... ok', [
                        'itemName' => $superUserRoleName,
                    ])
                ];
            }
